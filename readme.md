...
## Latest Changes
changed some text in Areas, changed the wiki, changed the list of programs in this readme, added some text in Raspberry Pi Detector, and added a new program called Box.
